(function () {
    ...
    class ReadingPanel extends Laya.Sprite {
        constructor(_w, _h, m_t) {
            ...
            var media_type = this.media_name.substr(this.media_name.lastIndexOf("."), this.media_name.length);
            switch (media_type) {
                case ".mp3":
    ...
    class MainQuestion extends Laya.Sprite {
        ...
        onEnable() {
            ...
            this.startCountDown();
            this.btn_next = new Button(this.btn_skin_path);
            ...
            Laya.loader.load(this.arr_assets, Handler.create(this, this.onAssetLoaded));
    ...
    class SpriteStart extends Sprite$5 {
        ...
        onEnable() {
            super.onEnable();
            this.btn_start = new Button$1(this.btn_skin_path);
    ...
    class MainScene extends Laya.Script {
        ...
        onEnable() {
            super.onEnable();
            Laya.loader.load("res/atlas/q_comp.atlas", Handler$1.create(this, this.onProgressLoaded));
        }
        onProgressLoaded() {
            ...
            Laya.loader.retryNum = 3;
            Laya.loader.load(this.arr_assets, Handler$1.create(this, this.onAssetLoaded), Handler$1.create(this, this.onAssetLoading, null, false));
